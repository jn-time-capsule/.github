...
<details>
<summary> <h3> 도쿠도쿠 (Dokudoku) </h3> </summary>

도서 검색부터 **읽기 상태 관리, 위시리스트, 컬렉션, 인상 깊은 문장 저장**까지  
한 곳에서 관리할 수 있는 반응형 독서 기록 웹 서비스입니다.  
웹으로도, 폰에서도(모바일) 편하게 사용할 수 있어요.

> ✅ 로그인 없이 도서 검색 가능  
> ✅ 로그인 시 내 서재/문장/컬렉션 저장 및 조회

**"독서는 꾸준하게, 기록은 체계적으로, 문장은 오래 남게."**

## 🖼️ 미리보기 (Screenshots)

| 홈 | 로그인 |
| --- | --- |
| <img width="1863" height="2297" alt="image" src="https://github.com/user-attachments/assets/f9c18815-a7ed-4357-87f7-9f81594679f5" /> | <img width="1878" height="927" alt="image" src="https://github.com/user-attachments/assets/797e1462-c335-44e1-af4b-b4d9eaf4136e" /> |

| 내 서재/컬렉션 | 문장 저장 | 마이페이지 |
| --- | --- | --- |
| <img width="1878" height="927" alt="image" src="https://github.com/user-attachments/assets/cfd734af-50b6-4382-a0b3-8163150d8e18" /> | <img width="1878" height="927" alt="image" src="https://github.com/user-attachments/assets/c6e78756-d622-4a89-a4a6-5e9e28f3cc74" /> | <img width="1863" height="2167" alt="image" src="https://github.com/user-attachments/assets/ec4b4735-5a0b-4c5e-a37c-19b878348204" /> |

## ✅ 주요 기능

- **도서 검색 (비회원 가능)**  
  - 로그인 없이 도서명/저자 기반 검색 가능

- **소셜 로그인**
  - 로그인 시 내 독서 데이터 저장/조회 가능

- **내 서재 관리**
  - 책 상태 관리: 위시리스트 / 읽는 중 / 완독
  - 진행률, 평점, 리뷰 기록

- **컬렉션 기능**
  - 컬렉션 생성/수정/삭제
  - 컬렉션별 책 분류 및 공개 여부 설정
...
- **캘린더**
  - 월별 달력에서 **독서 기록이 있는 날**을 한눈에 확인
  - 날짜를 선택하면 **그날 읽은(완독 기준) 책** 목록과 진행률 확인
  - 이전·다음 달로 이동하며 기록 탐색

- **마이페이지**
  - 독서 통계(읽은 책, 위시리스트, 컬렉션, 문장)
  - 최근 활동(책/컬렉션/문장) 모아보기

## 🧾 사용 흐름

1. 로그인(또는 비회원으로 도서 검색)
2. 책을 내 서재에 추가
3. 읽기 상태/진행률/평점/리뷰 기록
4. 컬렉션으로 분류 정리
5. 인상 깊은 문장을 저장하고 관리
6. 캘린더에서 날짜별로 읽은 책을 돌아보며 기록 확인
